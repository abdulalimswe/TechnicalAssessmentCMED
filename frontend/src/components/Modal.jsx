      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3 text-center">
          ...
          <div className="items-center px-4 py-3">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-200 text-gray-700 text-base font-medium rounded-md w-24 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300"
            >
              Cancel
            </button>
          </div>
